...
| MapLibre GL JS | 6.7.0 | MapLibre contributors | BSD-3-Clause | unmodified ESM renderer and bundled worker for ATLAS, Air Atlas/Fly With and opt-in report maps | `prototype/drive-lab/` |
...
- **Ange Yaghi — engine-sim**: [https://github.com/ange-yaghi/engine-sim/tree/85f7c3b959a908ed5232ede4f1a4ac7eafe6b630](https://github.com/ange-yaghi/engine-sim/tree/85f7c3b959a908ed5232ede4f1a4ac7eafe6b630). Physical firing/acoustic paths, wheel/gear kinematics and manual clutch control. Ten declared-MIT repository impulse responses and their licence were downloaded with hashes only into ignored local references; these are filters, not engine loops. No code or IR shipped. The newer Community Edition does not supply application source or an equivalent asset reuse grant.
...
## Atlas and Discover nearby POI lookup — 2026-09-08
...
OpenFreeMap POIs remain an Atlas fallback. Discover reuses the bounded service query, displays OSM attribution and links points without manufacturing Wikipedia articles. Google Maps URLs are outbound links only
...
## MapLibre security migration — 2026-09-12

MapLibre contributors, [MapLibre GL JS v6.7.0](https://github.com/maplibre/maplibre-gl-js/releases/tag/v6.7.0), BSD-3-Clause with the bundled prior Mapbox and d3-color notices retained. Source package: `https://registry.npmjs.org/maplibre-gl/-/maplibre-gl-6.7.0.tgz`; npm integrity `sha512-Y1Q1+UP9WXou0DUrnaFdDsoMqiMCWy6aS968IBUaQ2eZi6H1/kPCfpfZOWXFJZbeKMkX9Wo6OFzY/k48qqPf3Q==`. The downloaded tarball was independently hashed before admission. No upstream source modification; project adapters configure namespace imports, a same-origin bundled module worker and WebGL2 context attributes. The release fixes [GHSA-jrc7-96c5-q579](https://github.com/advisories/GHSA-jrc7-96c5-q579). Geographic services/data and aircraft artwork keep their independent terms. No media rights are inferred from the software license.
