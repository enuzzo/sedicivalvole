...
| Orbitron variable font | Google Fonts v35 | Matt McInerney and the Orbitron Project Authors | SIL Open Font License 1.1 | locally hosted Latin WOFF2 for interface typography; the selected 16 Road mark converts the `16` at weight 750 into stable vector outlines | `prototype/drive-lab/public/fonts/`, `logo/` |
