...
| [Tabler Icons — report-analytics outline and navigation filled icons](https://github.com/tabler/tabler-icons/tree/v3.46.0/icons) | 3.46.0 (icon metadata 1.39 / 2.0) | Copyright (c) 2020-2026 Paweł Kuna | MIT | official SVGs retained byte-identically; monochrome presentation and live ATLAS rotation applied by product CSS | `prototype/drive-lab/public/third-party/tabler-icons/` |
