...
| [Tabler Icons — report-analytics outline icon](https://github.com/tabler/tabler-icons/blob/v3.46.0/icons/outline/report-analytics.svg) | 3.46.0 (icon metadata 1.39) | Copyright (c) 2020-2026 Paweł Kuna | MIT | official SVG retained byte-identically; monochrome presentation applied by product CSS | `prototype/drive-lab/public/third-party/tabler-icons/` |
...
| Space Grotesk variable font | Google Fonts snapshot `2026-08-30`, upstream version 2.000 | Florian Karsten and the Space Grotesk Project Authors | SIL Open Font License 1.1 | locally hosted unmodified variable TrueType file for all live product, LAB, and diagnostic typography | `prototype/drive-lab/public/fonts/` |
| Orbitron variable font | Google Fonts v35 | Matt McInerney and the Orbitron Project Authors | SIL Open Font License 1.1 | no live runtime font remains; the selected 16 Road mark retains the `16` converted at weight 750 into stable vector outlines | `prototype/drive-lab/public/fonts/OFL-Orbitron.txt`, `logo/` |
