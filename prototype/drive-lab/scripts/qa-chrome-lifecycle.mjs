...
export async function auditChrome(page, output) {
  ...
  await page.keyboard.down('ArrowUp'); await page.waitForTimeout(1400); await page.keyboard.up('ArrowUp');
  await resting('motion retracts');
  await page.mouse.click(350,400); await resting('motion ignores ambient wake');
