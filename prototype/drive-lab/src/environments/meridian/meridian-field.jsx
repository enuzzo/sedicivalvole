...
export function MeridianField({ speed, theme, reducedMotion, onRenderer, onFrame }) {
  ...
  useEffect(() => {
    ...
    const renderer = createMeridianRenderer(canvas, valuesRef.current.palette);
    if (!renderer) {
      onRenderer("Meridian shader error");
      return undefined;
    }
