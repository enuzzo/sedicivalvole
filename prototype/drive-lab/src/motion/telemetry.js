...
const booleanKeys = ["dataFresh", "placementConfirmed", "mountSelected", "iceComplete", "accelerometer", "gyroscope", "orientation", "orientationEstimated", "tared", "secureContext", "rtc", "wakeLock", "supportsUiContext", "receiverConfirmed", "referenceReceived"];
