...
Modular Aperture is calm and comparatively flat at rest. Zero speed uses a deliberate Swiss score field: intact horizontal bars follow a repeated five-cell cadence across staggered rows, with rare body-color accents, a thin central datum, and an extremely slow tonal breath. No grid seams remain visible. The field progressively forms a centered funnel/tunnel with a dark terminal void as energy rises and returns coherently toward flatness during deceleration. At high energy, modules travel outward from the central vanishing point to communicate continuous forward flight. Actual speed remains a separate visual parameter after energy saturates: around 150 km/h the panels stretch into fast radial stripes and compress perceived depth into a Plaid-like velocity field. Curated Pearl, Graphite, Red, Blue, and Silver body-color themes change the visual character without exposing low-level shader controls. See [`RECOVERED-REQUIREMENTS-2026-08-26.md`](RECOVERED-REQUIREMENTS-2026-08-26.md).
