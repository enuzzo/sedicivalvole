...
- [x] present compact, equal-weight **Illobo Featured** and **Jamendo Library**
  ...
  four-second-per-direction crossfade on an unclipped square dark field;
