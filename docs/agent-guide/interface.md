...
The owner-selected September 11 entrance leaves the Signal Gate unobscured for three seconds, then expands the chooser from its center over 620 ms. Hidden controls are not focusable during the delay; reduced motion reveals the chooser without scaling or a visible fade. Preparation continues in parallel and menu/selection updates must not replay the entrance.
