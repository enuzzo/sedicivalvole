...
- JUNCTION must not equate road energy with a permanently loud break. Keep rest free of beat and bassline, introduce a quiet native-tempo break near `13 km/h`, cap the authored tempo ladder at `168 BPM`, and grow intensity primarily through orchestration, dynamics, punctuation and effects. Randomness chooses complete authored takes only at eight-bar boundaries, never repeats the same take immediately, and never chooses a bass recording without checking it against the voiced chord.
