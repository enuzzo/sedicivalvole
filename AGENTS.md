...
- `VERTIGO 02` embeds the byte-identical Codrops/Tympanus Infinite Lights Interstate 7 runtime from commit `e58d58520bc0dfde21f9e14e6a1b8c7f0a2a2a9e` as separately licensed third-party material. Do not alter, restyle, trim, or relicense its road, light sticks, car trails, bloom, camera, distortion, dependencies, or source shell. Drive only the original time/FOV controls through the external sedicivalvole speed bridge; keep upstream-integrity tests and attribution green.
