...
- 🧱 ATLAS has a tested, session-only A3 motion foundation: eight monotonic GPS samples, timestamp-based 30/60 FPS interpolation, stale-data freeze and no extrapolation. The vehicle point, high-rate feed and selected visual treatment are intentionally not connected before the remaining three-direction overlay gate;
